...
export default function MapScreen() {
  ...
  useEffect(() => {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyApTGaiyrwLMC6-OcWmTwGx5uYcvd7Q3RY&libraries=places`;
    script.async = true;
  ...
  // Function to cycle through alternative routes
  const cycleRoute = () => {
  ...
  useEffect(() => {
    ...
    routesData.forEach((route, index) => {
      ...
      const polyline = new window.google.maps.Polyline({
        ...
        clickable: false // Prevent clicking on the line from triggering pin drops
      });
